...
class UNET_AttentionBlock(nn.Module):
    ...
    def forward(self, x, context):
        ...
        #normalizaation + cross_Attention with skip connectio
        ...
        #normalization + FF  GEGlu and skip connnection
...
class UpSample(nn.Module):
    ...
    def forward(self ,x):
        #(batch_size, features, height, width) -> (batch_size, features , hreight*2 , width*2)
...
class Diffusion(nn.Module):
    ...
    def forward(self, latent:torch.Tensor, context :torch.Tensor, time:torch.Tensor):
        ...
        #(batch, 320 , height/8, width/8) -> (batch, 4, heigth/8, width/8)
